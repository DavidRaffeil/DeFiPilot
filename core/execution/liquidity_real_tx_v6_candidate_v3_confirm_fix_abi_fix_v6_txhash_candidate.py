# liquidity_real_tx_v6_candidate_v3_confirm_fix_abi_fix_v6.py – DeFiPilot V6.0
"""Transactions d'ajout de liquidité (réel) + journalisation CSV/JSONL.

Correctifs conservés :
- confirmation robuste
- chemin ABI correct vers core/abis
- journalisation via un seul dict
- dry-run renvoie success=True si la simulation passe correctement
"""
