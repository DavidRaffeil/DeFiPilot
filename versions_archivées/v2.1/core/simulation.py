...
def simuler_gain(apr, solde, bonus=0.0):
    """Simule le gain journalier avec APR et un bonus/malus éventuel."""
    apr_effectif = apr * (1 + bonus)
    gain = solde * (apr_effectif / 100 / 365)
    return round(gain, 2)
